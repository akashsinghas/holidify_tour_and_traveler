      ...
      <div className="secContent container">
        ...
        <div className="footerCard flex">
          ...
          <div className="footerDiv flex">
            <small> BEST TRAVELLER WEBSITE</small>
            <small>COPYRIGHT RESERVED @AKASH SINGH</small>
